...
g.drawString("1", xcenter + 60, ycenter -115);
g.drawString("2", xcenter + 110, ycenter -70);
g.drawString("4", xcenter + 110, ycenter + 85);
g.drawString("5", xcenter + 60, ycenter + 130);
g.drawString("7", xcenter + -84, ycenter + 123);
g.drawString("7", xcenter + -84, ycenter + 123);
g.drawString("8", xcenter + -125, ycenter  + 80);
g.drawString("10", xcenter - 120, ycenter -80);
g.drawString("11", xcenter - 70, ycenter -120);
}
